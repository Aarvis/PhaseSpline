...
from lehome_spline.exporting import export_embeddings
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Export posterior means/log-variances for every episode frame")
